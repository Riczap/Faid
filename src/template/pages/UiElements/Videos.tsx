...
export default function Videos() {
  return (
    <>
      <PageMeta
        title="React.js Videos Tabs | Faid - React.js Admin Dashboard Template"
        description="This is React.js Videos page for Faid - React.js Tailwind CSS Admin Dashboard Template"
      />
