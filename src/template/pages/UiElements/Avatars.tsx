...
export default function Avatars() {
  return (
    <>
      <PageMeta
        title="React.js Avatars Dashboard | Faid - React.js Admin Dashboard Template"
        description="This is React.js Avatars Dashboard page for Faid - React.js Tailwind CSS Admin Dashboard Template"
      />
